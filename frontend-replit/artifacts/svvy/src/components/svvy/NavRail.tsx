    ...
    >
        ...
        {collapsed ? (
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 min-w-0">
              <span className="font-mono text-[11px] text-orange-500 font-semibold tracking-tight">
                svvy
              </span>
          ...
          <div className="px-3 pb-2">
            ...
            <div className="space-y-1">
              {mockFolderGroups.map((group) => (
                <div
                  key={group.label}
                  className="rounded border border-sidebar-border/60 bg-sidebar-accent/20 px-2 py-1.5"
                >
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] text-sidebar-foreground/80">{group.label}</span>
                    <span className="font-mono text-[9px] text-sidebar-foreground/40">
          ...
          <>
            ...
            {expandedSections.workflows && (
              <div className="px-1">
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] text-sidebar-foreground/80 font-mono truncate">
                      auth-refactor-ci
                    </span>
                    <span className="text-[9px] font-mono text-orange-400 border border-orange-500/20 bg-orange-500/10 rounded px-1">
                      3/8
                    </span>
                  </div>
                </button>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[9px] font-mono text-red-400 border border-red-500/20 bg-red-500/10 rounded px-1">
                      fail
                    </span>
                  </div>
                </button>
              ...
              <div className="px-1">
                ...
                >
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[11px] text-sidebar-foreground/80 truncate">
              ...
              {mockPaneSurfaces.map((surface) => (
                ...
                >
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="font-mono text-[9px] text-sidebar-foreground/40 truncate">
      ...
      <div
        className={cn(
          ...
          collapsed
            ? "px-2 py-2 flex flex-col items-center gap-2"
