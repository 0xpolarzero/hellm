...
```bash
pnpm --filter @smthrs/smithers-demo dev
```
...
```bash
pnpm --filter @smthrs/smithers-tui-demo tui
```
...
```bash
CEREBRAS_API_KEY=... pnpm --filter @smthrs/smithers-demo cerebras:debate
OPENAI_API_KEY=... pnpm --filter @smthrs/smithers-demo cerebras:debate
ANTHROPIC_API_KEY=... pnpm --filter @smthrs/smithers-demo cerebras:debate
```
...
```bash
pnpm --filter @smthrs/smithers-demo test
pnpm --filter @smthrs/smithers-demo build
pnpm --filter @smthrs/smithers-demo e2e
pnpm --filter @smthrs/smithers-tui-demo test
```
