...
execution, resume, inspection, approval, and debugging flows. Use `bunx smthrs init`,
`bunx smthrs workflow run`, `bunx smthrs ps`, and
`bunx smthrs inspect` as ordinary shell commands when Smithers work is the right unit.
