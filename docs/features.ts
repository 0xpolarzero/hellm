...
export const PRODUCT_FEATURES: ProductFeature[] = [
  ...
  },
  {
    ...
    status: "shipped",
    summary:
      "Presents generated artifacts as explicit Dockview artifact inspector panes keyed by durable artifact identity, opens or focuses those panes from succeeded terminal `open_artifact_inspector` command facts delivered through committed command-inspector invalidations and deduplicated by command id, and isolates visible HTML previews in sandboxed iframes that grant script execution only without same-origin, navigation, popup, form, or parent/app escape permissions.",
    sourceSpecs: [
      "docs/prd.md",
