...
const CX_CONTEXT_PROMPT = [
  ...
  "",
  "cx is the semantic code-navigation layer for repository inspection. Prefer cx for structural exploration before reading full files.",
  "",
  ...
  "- `read`, `grep`, `find`, or `ls` when semantic navigation is insufficient, when raw text is required, or when the target is not supported by cx.",
  "",
  "cx command behavior:",
