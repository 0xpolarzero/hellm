...
describe("Smithers instruction generator", () => {
  ...
  it("keeps current svvy Smithers prompt boundaries while preserving official concepts", () => {
    expect(SMITHERS_CORE_INSTRUCTIONS).toContain("smithers init");
    expect(SMITHERS_CORE_INSTRUCTIONS).toContain("smithers workflow run");
    expect(SMITHERS_CORE_INSTRUCTIONS).toContain("smithers ps");
    expect(SMITHERS_CORE_INSTRUCTIONS).toContain("smithers inspect");
    ...
    expect(SMITHERS_CORE_INSTRUCTIONS).toContain("smithers approve <run-id>");
