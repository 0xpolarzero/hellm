...
export const BUILTIN_EXTENSIONS = [
  ...
  },
  {
    ...
    instructionSourceFiles: ["src/bun/default-system-prompt.ts"],
    minimalLoadingHint: "Orchestrator role instructions are loaded for orchestrator surfaces.",
    typescriptApiEnabled: false,
    envReadiness: "not_required",
    dependencyReadiness: "not_required",
    generatedInstructions: [
  ...
  },
  {
    ...
    instructionSourceFiles: ["src/bun/default-system-prompt.ts"],
    minimalLoadingHint: "Handler role instructions are loaded for delegated handler surfaces.",
    typescriptApiEnabled: false,
    envReadiness: "not_required",
    dependencyReadiness: "not_required",
    generatedInstructions: [
  ...
  },
  {
    ...
    instructionSourceFiles: ["src/bun/default-system-prompt.ts"],
    minimalLoadingHint: "Workflow task-agent role instructions are loaded for task attempts.",
    typescriptApiEnabled: false,
    envReadiness: "not_required",
    dependencyReadiness: "not_required",
    generatedInstructions: [
