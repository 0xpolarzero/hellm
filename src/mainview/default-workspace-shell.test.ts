...
describe("default workspace renderer shell", () => {
  ...
  it("renders CLI readiness from the Extensions inventory read model", async () => {
    ...
    expect(runtimeSource).toContain("loadExtensionSnapshot");
    ...
    expect(extensionsPaneSource).not.toContain("file.editable || file.bypassed");
    ...
    expect(extensionInstructionEditorSource).not.toContain("generator loaded");
